...
class ApiOperatorsTestCase(unittest.TestCase):
    ...
    def test_operators_create(self):
        content_body = {
            'username' : 'tester-1',
            'password' : 'hogehoge',
            'state'    : '2'
    ...
    def test_operators_read_one(self):
        content_body = {
            'username' : 'tester-2',
            'password' : 'hogehoge',
            'state'    : '1'
    ...
    def test_unknown_operators_read_one(self):
        raw_response = self.app.get(
            '/operators/%d' % 1000000
        )
    ...
    def test_unknown_operators_update(self):
        content_body = {
            'username' : 'anything',
            'password' : 'hogehoge',
            'state'    : '3'
    ...
    def test_operators_delete(self):
        content_body = {
            'username' : 'tester-4',
            'password' : 'hogehoge',
            'state'    : '3'
    ...
    def test_unknown_operators_delete(self):
        raw_response = self.app.delete(
            '/operators/%d' % 100000
        )
        assert raw_response.status_code == 404
